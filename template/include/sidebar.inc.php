  ...
  <nav id="sidebar" class="sidebar-wrapper">
    <div class="sidebar-content">
      <div class="sidebar-brand">
        <a href="#">SMSports</a>
        <div id="close-sidebar" class="close" aria-label="Close">
      ...
      <div class="sidebar-header">
        ...
        <div class="user-info">
          ...
          switch($me->role()){
            case 1:echo"ADMINISTRATEUR";
            break;
            case 2:echo"Membre du comité";
            break;
            case 3:echo"Adhérent";
            break;}
            ?></span>
        ...
        <ul>
          ...
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                ...
                <li>
                  <a href="">Suivi des modifications
                    <span class="badge badge-pill badge-warning">Admin</span>
                  </a>
                </li>
                <li>
                  <a href="">Gestion des séances
                    <span class="badge badge-pill badge-success">cadre</span>
                  </a>
                </li>
                <li>
                  <a href="">Validation des adhérents
                    <span class="badge badge-pill badge-success">cadre</span>
                  </a>
                </li>
              </ul>
          ...
          <li class="sidebar-dropdown">
            <a >
              ...
              <span>Compétition SMS</span>
            </a>
            <div class="sidebar-submenu">
              <ul>
                <li>
                  <a href="#">Challenge SMS</a>
                </li>
                <li>
                  <a href="#">Ligue Badminton</a>
                </li>
                <li>
                  <a href="#">Ligue Ping</a>
                </li>
                <li>
                  <a href="#">Ligue Volley</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                ...
                <li>
                  <a href="#">Rapports/Bilans</a>
                </li>
                <li>
                  <a href="#">Tarifs adhésion</a>
                </li>
                 <li>
                  <a href="#">Suivi participants
                    <span class="badge badge-pill badge-success">cadre</span>
                  </a>
                </li>
              </ul>
